...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rapid-pine-cb18)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-pine-cb18
```

A live public deployment of this template is available at [https://rapid-pine-cb18.templates.workers.dev](https://rapid-pine-cb18.templates.workers.dev)
